		...
		<el-row :gutter="20">
			<el-col :sm="24" :lg="24">
				...
				>
					...
					<h4 class="text-danger" style="margin-top: 10px">
		...
		<el-row :gutter="20">
			...
			<el-col :xs="24" :sm="24" :md="12" :lg="8">
				<el-card class="update-log">
					...
					<span
						style="height: 30px; line-height: 30px; color: #458b00"
					>
						你可以请作者喝杯咖啡表示鼓励
					</span>
				...
				<el-card class="update-log">
					...
					<div class="body">
						...
						<p>
							...
							<s>满104180207</s> <s>满186866453</s>
							<s>满201396349</s> <s>满101456076</s>
							<s>满101539465</s> <s>满264312783</s>
							<s>满167385320</s>
							<a
								href="https://jq.qq.com/?_wv=1027&k=DuWxuULe"
								target="_blank"
							>
								139821253</a
							>
